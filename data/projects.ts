    ...
    images: [
      {
        ...
        height: 667,
        className:
          "phone-md:w-38 phone-lg:-mt-5 mx-auto desktop-sm:mt-4 phone-lg:w-44 desktop-md:-mt-2 phone-md:mt-3 tablet-md:w-60 desktop-sm:w-40 desktop-xl:w-52",
      },
      {
        ...
        height: 667,
        className:
          "-mt-4 tablet-sm:w-52 tablet-md:w-60 phone-md:-mt-6 desktop-md:mt-8 phone-md:w-36 desktop-sm:-mt-6 mx-auto desktop-sm:w-40 tablet-sm:-mt-14 phone-lg:-mt-14 phone-lg:w-44 desktop-xl:w-52",
      },
      {
        thumbnail:
        ...
        height: 667,
        className:
          "translate-y-8 tablet-sm:w-52 tablet-md:w-60  desktop-md:translate-y-full desktop-sm:w-40 phone-md:w-38 mx-auto phone-lg:w-44 desktop-xl:w-52",
      },
      {
        ...
        height: 667,
        className:
          "-mt-18 tablet-sm:w-52 tablet-sm:-mt-28 tablet-md:w-60 phone-md:w-36 desktop-md:mt-8 desktop-md:mt-0 desktop-sm:-mt-24 desktop-sm:w-40 tablet-md:-mt-32 phone-lg:w-44 phone-md:-mt-28 phone-lg:-mt-26 mx-auto desktop-xl:w-52",
      },
    ],
  },
    ...
    images: [
      {
        ...
        height: 667,
        className:
          "phone-md:w-36 mx-auto desktop-sm:mt-4 desktop-sm:w-40 phone-md:mt-2 phone-lg:w-44 phone-lg:-mt-5 tablet-sm:w-52 tablet-md:w-60 desktop-xl:w-52",
      },
      {
        ...
        height: 667,
        className:
          "-mt-6 desktop-sm:-mt-6 mx-auto phone-md:w-36 desktop-sm:w-40 tablet-sm:w-52 tablet-md:w-60 phone-lg:w-44 desktop-xl:w-52 phone-lg:-mt-14",
      },
      {
        ...
        height: 667,
        className:
          "phone-md:w-34 desktop-sm:mt-2 tablet-sm:w-52 desktop-sm:w-40 tablet-sm:mt-2 tablet-md:w-60 phone-lg:w-44 desktop-xl:w-52 mx-auto",
      },
      {
        ...
        height: 667,
        className:
          "mx-auto desktop-sm:-mt-4 tablet-sm:-mt-2 phone-lg:w-44 desktop-sm:w-40 phone-lg:-mt-4 phone-md:-mt-3 desktop-xl:w-52 tablet-sm:w-52 tablet-md:w-60 phone-md:w-36",
      },
    ],
  },
  {
