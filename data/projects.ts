...
export const projects: Project[] = [
  {
    ...
    images: [
      ...
      },
      {
        ...
        height: 667,
        className:
          "-mt-4 tablet-sm:w-52 tablet-md:w-62 phone-lg:-mt-12 desktop-md:mt-8 phone-md:w-36 desktop-sm:-mt-6 mx-auto tablet-sm:-mt-14 phone-lg:w-44",
      },
      {
        thumbnail:
      ...
      },
      {
        ...
        height: 667,
        className:
          "-mt-18 tablet-sm:w-52 tablet-sm:-mt-35 tablet-md:w-62 phone-md:w-36 desktop-md:mt-8 desktop-md:mt-0 desktop-sm:-mt-24 tablet-md:-mt-40 phone-lg:w-44 phone-lg:-mt-30 phone-md:-mt-22 mx-auto",
      },
    ],
  },
    ...
    images: [
      {
        ...
        height: 667,
        className:
          "tablet-md:w-62 phone-md:w-36 phone-lg:w-44 w-34 tablet-sm:w-54 border-2 border-grey-2 mx-auto",
      },
      {
        ...
        height: 667,
        className:
          "-mt-4 tablet-md:w-62 w-34 phone-lg:-mt-12 desktop-md:mt-0 phone-md:w-36 desktop-sm:-mt-6 tablet-sm:w-54 tablet-sm:-mt-14 phone-lg:w-44 border-2 border-grey-2 mx-auto ",
      },
      {
        ...
        height: 667,
        className:
          "tablet-md:w-62 tablet-md:-mt-24 w-30 border-2 border-grey-2 -mt-14 desktop-md:translate-y-full tablet-sm:w-54 tablet-sm:-mt-16 phone-md:w-36 desktop-sm:-mt-18 phone-lg:w-44 phone-lg:-mt-12 mx-auto ",
      },
      {
