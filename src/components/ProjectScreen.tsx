  ...
  return (
    <>
      <div className="grid gap-4 tablet-md:grid-cols-1 desktop-sm:items-start">
        ...
        <div className="grid grid-cols-2 desktop-md:grid-cols-4 desktop-md:-translate-x-1/5 desktop-xl:w-4xl desktop-sm:ml-0 desktop-md:w-2xl desktop-lg:w-3xl desktop-sm:w-100 desktop-sm:gap-x-6 gap-4 phone-md:gap-x-0 ml-6 tablet-md:ml-16 tablet-md:w-140">
