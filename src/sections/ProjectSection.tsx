  ...
  return (
    ...
    >
      <div className="desktop-sm:grid desktop-sm:items-start desktop-sm:gap-y-4 desktop-sm:gap-x-8 desktop-sm:grid-cols-2 desktop-md:gap-y-2">
        ...
        <div
          className={`phone-sm:mt-6 desktop-sm:col-start-2 desktop-sm:row-start-1 desktop-sm:row-span-2 desktop-sm:self-start desktop-md:mt-0 ${screenContainerClassName}`}
        >
          <ProjectScreen
