...
export const Description = () => {
  return (
    <section className="relative phone-sm:h-[84vh] h-screen desktop-lg:ml-10 desktop-sm:h-[68vh] desktop-lg:h-[60vh] tablet-lg:h-[48vh] desktop-xl:h-[56vh] tablet-sm:ml-12 min-[375px]:h-[92vh] tablet-md:h-[52vh] min-[390px]:h-[70vh] phone-md:max-h-[74vh] min-[428px]:h-[68vh] phone-lg:h-[60vh] py-8 ml-3">
      <Divider
      ...
      <p className="mt-2 desktop-xl:max-w-120 desktop-xl:text-xl desktop-sm:max-w-92 desktop-sm:text-base tablet-md:max-w-116 tablet-sm:max-w-92 phone-md:max-w-80 text-xs phone-sm:text-sm phone-lg:pl-2 phone-lg:max-w-76 phone-md:text-base phone-sm:max-w-68 text-text leading-loose tracking-wide ml-3 w-full max-w-60 wrap-break-words whitespace-normal">
      ...
      <img
        ...
        loading="lazy"
        className="object-cover phone-md:w-36 desktop-xl:w-84 desktop-sm:w-72 desktop-sm:mr-24 phone-lg:w-44 phone-lg:-mr-3 tablet-sm:w-52 tablet-md:w-60"
      />
    </section>
  );
};
