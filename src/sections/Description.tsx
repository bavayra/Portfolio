...
export const Description = () => {
  return (
    <section className="relative h-[84vh] desktop-lg:ml-10 desktop-sm:h-[70vh] desktop-lg:h-[60vh] desktop-xl:h-[56vh] tablet-sm:ml-12 min-[375px]:h-[92vh] tablet-md:h-[52vh] min-[390px]:h-[70vh] phone-md:max-h-[74vh] min-[428px]:h-[68vh] phone-lg:h-[72vh] py-8 ml-3">
      <Divider
