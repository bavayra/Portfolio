...
export const Description = () => {
  return (
    <section className="relative phone-sm:h-[84vh] h-screen desktop-lg:ml-10 desktop-sm:h-[68vh] desktop-lg:h-[60vh] tablet-lg:h-[40vh] desktop-xl:h-[56vh] tablet-sm:ml-12 min-[375px]:h-[92vh] tablet-md:h-[44vh] min-[390px]:h-[70vh] phone-md:max-h-[74vh] min-[428px]:h-[68vh] phone-lg:h-[63vh] tablet-sm:h-[55vh] py-8 ml-3">
      <Divider
      ...
      <p className="mt-2 desktop-xl:max-w-120 desktop-xl:text-xl desktop-sm:max-w-92 desktop-sm:text-base tablet-md:max-w-116  phone-md:max-w-80 text-xs phone-sm:text-sm phone-lg:pl-2 phone-lg:max-w-76 phone-md:text-base phone-sm:max-w-68 tablet-sm:max-w-82 text-text leading-loose tracking-wide ml-3 w-full max-w-60 wrap-break-words whitespace-normal">
