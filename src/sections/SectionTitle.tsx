    ...
    <div className="section-vh flex flex-col relative ml-3 justify-center phone-md:pb-10 tablet-sm:ml-9 desktop-lg:ml-10">
      ...
      <div className="mb-4">
        ...
        <h2
          id={headingId}
          ref={ref}
          className="font-extrabold tracking-[0.2em] text-[2.5rem] leading-10 tablet-sm:text-[4rem] tablet-sm:leading-16 desktop-sm:text-[5rem] desktop-lg:text-[5.5rem] desktop-sm:leading-21 desktop-2xl:text-[7.5rem] desktop-2xl:leading-30 text-section-title"
        >
          {title}
        </h2>
      </div>
