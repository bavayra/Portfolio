...
const Contacts = () => {
  ...
  return (
    <section
      ...
      className="relative z-10 mt-20 ml-3 h-auto flex pb-8 flex-col items-center tablet-sm:ml-9 desktop-lg:ml-10 desktop-xl:h-[68vh] [@media(min-height:1200px)_and_(min-width:1920px)]:h-[58vh]"
    >
      <Divider
