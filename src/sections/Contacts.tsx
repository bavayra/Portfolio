...
const Contacts = () => {
  ...
  return (
    <section
      ...
      className="relative z-10 mt-20 ml-3 h-auto flex pb-8 flex-col items-center tablet-sm:ml-9 desktop-lg:ml-10 desktop-xl:h-[68vh] [@media(min-height:1200px)_and_(min-width:1920px)]:h-[58vh] [@media(min-height:1440px)_and_(min-width:1920px)]:h-[48vh]"
    >
      <Divider
        widthPx="var(--hero-div-w)"
        heightPx="var(--contacts-div-top-height)"
        leftPx={0}
        color="grey-2"
      ...
      <div className="flex flex-col desktop-sm:grid desktop-sm:grid-cols-2 desktop-sm:gap-x-10 desktop-md:gap-x-48">
        ...
        <SocialLinks
          size="md"
          className="flex flex-wrap max-w-60 tablet-sm:max-w-88 tablet-sm:gap-x-10 tablet-sm:gap-y-4 tablet-md:max-w-80 mx-auto justify-center mt-6 tablet-md:mt-12 desktop-xl:my-28 desktop-xl:mx-10 desktop-xl:max-w-100 desktop-xl:gap-x-16"
        />
      </div>
    </section>
  );
