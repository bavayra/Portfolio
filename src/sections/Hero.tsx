...
const Hero = () => {
  return (
    ...
    >
      ...
      <div
        className="grid grid-cols-[auto_1fr] grid-rows-[auto_auto_auto] ml-3 tablet-sm:ml-8 desktop-md:ml-10 relative"
        aria-hidden="true"
      >
      ...
      <div className="absolute left-7 top-32 min-h-[36vh] w-(--hero-div-w) bg-grey-2" />
