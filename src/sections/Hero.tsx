  ...
  return (
    <section id="hero" className="py-8 app-fullscreen relative overflow-hidden">
      ...
      <div className="grid grid-cols-1fr ml-4 min-[390px]:mt-10 phone-md:ml-4 min-[428px]:leading-16 leading-12 tablet-md:mt-40 tablet-lg:mt-52 phone-lg:mt-10 tablet-sm:mt-36 tablet-sm:ml-8 grid-rows-1fr">
        ...
        <h1 className="text-[length:var(--h1-size)] font-semibold text-grey-2 tablet-lg:text-9xl col-start-1 col-span-3 row-start-2 pl-3 ">
          Portfolio
        </h1>
        <p className="text-[length:var(--name-size)] tablet-lg:text-5xl tablet-lg:pr-20  text-accent-red tablet-md:pr-30 font-bold tracking-wider col-start-3 min-[375px]:pr-10 row-start-3 pr-8">
          ALIX BELL
        </p>
      </div>
