...
const Hero = () => {
  return (
    ...
    >
      ...
      />
      <div className="grid grid-cols-1fr mt-[var(--hero-mt)] ml-4 desktop-sm:translate-y-[75%] desktop-sm:leading-18 desktop-lg:leading-20 phone-md:ml-4 phone-lg:leading-12 tablet-sm:leading-16 leading-10 tablet-sm:ml-8 grid-rows-1fr">
        ...
        <p className="text-[length:var(--name-year-size)] desktop-md:mr-16 desktop-sm:col-start-2 desktop-xl:mr-60 desktop-sm:mr-40 tablet-lg:pr-20  text-accent-red tablet-md:pr-30 font-bold tracking-wider col-start-3 min-[375px]:pr-10 row-start-3 pr-8">
          ALIX BELL
        </p>
      </div>
      <Divider
