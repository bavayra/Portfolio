  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="col-start-1 col-span-2 row-start-3 pl-[40%] tablet-sm:pl-[49%] tablet-md:pl-[36%] tablet-lg:pl-[45%] desktop-sm:pl-[34%] desktop-md:pl-[29%] desktop-lg:pl-[30%] text-(length:--name-year-size) font-bold text-accent-red tracking-wider tablet-lg:text-[3.5rem] desktop-xl:text-7xl leading-10 phone-md:leading-12 tablet-sm:leading-14 desktop-sm:leading-18 desktop-lg:leading-20">
          ALIX BELL
        </p>
      </div>
