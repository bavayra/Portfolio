  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="mt-2 inline-block mr-4 phone-sm:mt-4 phone-sm:mr-8 tablet-sm:mr-16 tablet-sm:mt-0 rounded-md bg-accent-red text-white px-4 py-2.5 text-sm tablet-md:mr-30 desktop-sm:ml-6 desktop-sm:mt-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-red focus-visible:ring-offset-2 focus-visible:rounded-md focus-visible:ring-offset-bg"
      >
