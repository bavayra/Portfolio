  ...
  return (
    ...
    >
      <div className="leading-6.5 phone-lg:leading-7.5 tablet-sm:leading-8.5 desktop-2xl:leading-10">
        ...
        <h3 className="text-[2.75rem] text-grey-2 font-medium desktop-sm:text-5xl desktop-2xl:text-7xl" id="about-heading">
          WHO AM I
        </h3>
      </div>

      <p
        className="mt-2 text-[length:var(--font-body-sm)] phone-lg:mt-4 text-text leading-loose tracking-wide w-full wrap-break-word whitespace-normal pl-2 max-w-[var(--max-w-text-sm)] desktop-sm:max-w-[var(--max-w-text-lg)] desktop-xl:text-lg border-l-2 [@media(min-width:1920px)_and_(min-height:1440px)]:text-xl border-grey-2"
