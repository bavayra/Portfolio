const About = () => {
  return (
    ...
    >
      <div className="leading-7.5 tablet-sm:leading-8.5 desktop-2xl:leading-10">
        <p
        ...
        <h3
          className="text-[2rem] phone-lg:text-[2.5rem] text-grey-2 font-medium tablet-sm:text-[3rem] desktop-sm:text-5xl desktop-2xl:text-7xl"
          id="about-heading"
        >
          WHO AM I
        </h3>
      ...
      <a
        ...
        className="mt-2 inline-block mr-4 phone-sm:mt-4 phone-sm:mr-8 tablet-sm:mr-16 tablet-sm:mt-3 rounded-lg bg-accent-red text-white px-4 py-2.5 text-sm tablet-md:mr-30 desktop-sm:ml-2 desktop-sm:mt-4 desktop-lg:text-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-red focus-visible:ring-offset-2 focus-visible:rounded-lg focus-visible:ring-offset-bg"
      >
