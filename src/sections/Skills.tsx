...
const Skills = () => {
  return (
    <section
      ...
      className="relative ml-3 tablet-sm:ml-9 desktop-sm:ml-0 mb-4 tablet-sm:mt-8 tablet-md:mb-6 desktop-sm:mt-42 desktop-md:translate-y-[26%] desktop-sm:max-w-110"
    >
