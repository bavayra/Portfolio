...
export const projects = [
  ...
  },
  {
    ...
    imageClasses: {
      ...
      3: "-mt-17 mx-auto phone-md:-mt-22 phone-md:w-36 phone-lg:-mt-24 phone-lg:w-44 tablet-sm:-mt-30 tablet-sm:w-48 tablet-md:-mt-32 tablet-md:w-60 desktop-sm:w-40 desktop-sm:-mt-12 desktop-md:-translate-y-[5%] desktop-xl:w-52",
    },
    images: [
      {
  ...
  },
  {
    ...
    imageClasses: {
      ...
      2: "-mt-12 mx-auto w-30 phone-md:-mt-13 phone-md:w-36 phone-lg:w-44 phone-lg:-mt-16 tablet-sm:-mt-15 tablet-sm:w-50 tablet-md:-mt-26 tablet-md:w-60 border-2 border-grey-2 desktop-sm:w-44 desktop-xl:w-52 desktop-sm:-mt-20  desktop-md:-translate-y-[5%]",
