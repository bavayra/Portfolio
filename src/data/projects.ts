...
export const projects = [
  {
    ...
    imageClasses: {
      0: "mx-auto phone-md:mt-2 phone-md:w-36 phone-lg:-mt-5 phone-lg:w-44 tablet-sm:w-52 tablet-md:w-60 desktop-sm:w-40 desktop-xl:w-44 desktop-sm:mt-0",
      1: "-mt-6 mx-auto phone-md:w-36 phone-lg:-mt-14 phone-lg:w-44 tablet-sm:w-52 tablet-md:w-60 desktop-sm:w-40 desktop-xl:w-44 desktop-sm:mt-0",
      2: "mx-auto phone-md:w-34 phone-lg:w-44 tablet-sm:mt-2 tablet-sm:w-52 tablet-md:w-60 desktop-sm:w-40 desktop-xl:w-44 desktop-sm:mt-0",
      3: "mx-auto phone-md:-mt-3 phone-md:w-36 phone-lg:-mt-2 phone-lg:w-44 tablet-sm:-mt-2 tablet-sm:w-52 tablet-md:w-60 desktop-sm:w-40 desktop-xl:w-44 desktop-sm:mt-0",
    },
    images: [
      {
