...
export const projects = [
  {
    ...
    imageClasses: {
      ...
      1: "-mt-4 mx-auto phone-md:-mt-32 phone-md:w-36 phone-lg:-mt-14 phone-lg:w-44 tablet-sm:-mt-14 tablet-sm:w-52 tablet-md:w-60 desktop-sm:-mt-6 desktop-sm:w-40 desktop-md:mt-8 desktop-xl:w-52",
      ...
      3: "-mt-8 mx-auto phone-md:-mt-25 phone-md:w-36 phone-lg:-mt-26 phone-lg:w-44 tablet-sm:-mt-28 tablet-sm:w-52 tablet-md:-mt-32 tablet-md:w-60 desktop-sm:-mt-24 desktop-sm:w-40 desktop-xl:w-52",
    },
    images: [
      {
