...
export const projects = [
  ...
  },
  {
    ...
    imageClasses: {
      ...
      2: "mx-auto phone-md:w-38 phone-lg:w-44 tablet-sm:w-52 tablet-md:w-60 desktop-sm:w-40  desktop-md:w-44 desktop-md:mt-0 desktop-xl:w-52",
      3: "-mt-17 mx-auto phone-md:-mt-22 phone-md:w-36 phone-lg:-mt-24 phone-lg:w-44 tablet-sm:-mt-30 tablet-sm:w-48 tablet-md:-mt-32 tablet-md:w-60 desktop-sm:-mt-18 desktop-sm:w-40 desktop-md:w-44 desktop-md:mt-0 desktop-xl:w-52",
    },
    images: [
      {
  ...
  },
  {
    ...
    imageClasses: {
      ...
      1: "-mt-4 mx-auto w-34 phone-md:-mt-3 phone-md:w-36 phone-lg:-mt-12 phone-lg:w-44 tablet-sm:-mt-14 tablet-sm:w-50 tablet-md:-mt-26 tablet-md:w-60 border-2 border-grey-2 desktop-sm:w-44 desktop-lg:-mt-9 desktop-xl:w-52",
      2: "-mt-12 mx-auto w-30 phone-md:-mt-13 phone-md:w-36 phone-lg:w-44 phone-lg:-mt-16 tablet-sm:-mt-15 tablet-sm:w-50 tablet-md:-mt-26 tablet-md:w-60 border-2 border-grey-2 desktop-sm:-mt-13 desktop-sm:w-44 desktop-xl:w-52",
      3: "mx-auto w-30 phone-md:w-36 phone-lg:w-44 tablet-sm:mt-3 tablet-sm:w-54 tablet-md:w-60 border-2 border-grey-2 desktop-sm:w-44 desktop-xl:w-52",
    },
    images: [
      {
