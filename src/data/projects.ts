...
export const projects = [
  {
    ...
    imageClasses: {
      ...
      3: "mx-auto phone-md:-mt-3 phone-md:w-36 phone-lg:-mt-2 phone-lg:w-44 tablet-sm:-mt-2 tablet-sm:w-52 tablet-md:w-60 desktop-sm:-mt-2 desktop-sm:w-40 desktop-xl:w-52",
    },
    images: [
      {
  ...
  },
  {
    ...
    imageClasses: {
      0: "mx-auto phone-md:mt-3 phone-md:w-36 phone-lg:-mt-3 phone-lg:w-44 tablet-sm:w-52 tablet-md:w-60 desktop-sm:mt-4 desktop-sm:w-40 desktop-md:-mt-2 desktop-xl:w-52",
      1: "-mt-24 mx-auto phone-md:-mt-25 phone-md:w-36 phone-lg:-mt-36 phone-lg:w-44 tablet-sm:-mt-42 tablet-sm:w-52 tablet-md:w-60 desktop-sm:-mt-28 desktop-sm:w-40 desktop-md:mt-8 desktop-xl:w-52",
      ...
      3: "-mt-17 mx-auto phone-md:-mt-22 phone-md:w-36 phone-lg:-mt-24 phone-lg:w-44 tablet-sm:-mt-30 tablet-sm:w-48 tablet-md:-mt-32 tablet-md:w-60 desktop-sm:-mt-23 desktop-sm:w-40 desktop-xl:w-52",
    },
    images: [
      {
  ...
  },
  {
    ...
    imageClasses: {
      0: "mx-auto -mt-13 w-34 phone-md:w-36 phone-md:-mt-10 phone-lg:w-44 phone-lg:-mt-22 tablet-sm:w-52 tablet-md:-mt-34 tablet-md:w-60 border-2 border-grey-2 desktop-sm:-mt-10 desktop-sm:w-40 desktop-xl:w-52",
      1: "-mt-4 mx-auto w-34 phone-md:-mt-3 phone-md:w-36 phone-lg:-mt-12 phone-lg:w-44 tablet-sm:-mt-14 tablet-sm:w-50 tablet-md:w-60 border-2 border-grey-2 desktop-sm:-mt-2 desktop-sm:w-40 desktop-lg:-mt-9 desktop-md:-mt-4 desktop-xl:w-52",
      2: "-mt-12 mx-auto w-30 phone-md:-mt-13 phone-md:w-36 phone-lg:w-44 phone-lg:-mt-16 tablet-sm:-mt-15 tablet-sm:w-50 tablet-md:-mt-26 tablet-md:w-60 border-2 border-grey-2 desktop-sm:-mt-13 desktop-sm:w-40 desktop-md:translate-y-2/3 desktop-xl:w-52",
