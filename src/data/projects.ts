...
export const projects = [
  ...
  },
  {
    ...
    imageClasses: {
      0: "mx-auto -mt-13 w-34 phone-md:w-36 phone-md:-mt-10 phone-lg:w-44 phone-lg:-mt-22 tablet-sm:w-54 tablet-md:-mt-5 tablet-md:w-60 border-2 border-grey-2 desktop-sm:mt-4 desktop-sm:w-40 desktop-xl:w-52",
      ...
      2: "-mt-12 mx-auto w-30 phone-md:-mt-13 phone-md:w-36 phone-lg:w-44 phone-lg:-mt-16 tablet-sm:-mt-13 tablet-sm:w-54 tablet-md:-mt-22 tablet-md:w-60 border-2 border-grey-2 desktop-sm:-mt-9 desktop-sm:w-40 desktop-md:translate-y-2/3 desktop-xl:w-52",
